                                            ...
                                            <div className="flex gap-3 md:gap-4">
                                                {otp.map((digit, index) => (
                                                    <input
                                                        ...
                                                        className={`w-10 h-10 md:w-12 md:h-12 border ${digit ? 'border-[#E7C200]' : 'border-black/30'} rounded-[12px] text-center text-xl font-bold focus:outline-none focus:border-[#E7C200] bg-white transition-colors mt-3`}
                                                    />
                                                ))}
                                            </div>
                                            <button className="text-[14px] font-medium text-[#E7C200] ">
                                                Resend OTP
                                            </button>
                                        </div>

                                        <Link href="/list-your-play/setup/agreement">
