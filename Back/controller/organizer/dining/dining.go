...
func VerifyOTP(c *fiber.Ctx) error {
	...
	if err := config.SetAuthCookies(c, org.ID.Hex(), org.Email, role, "dining", isAdmin, org.CategoryStatus); err != nil {
...
func DiningSetup(c *fiber.Ctx) error {
...
func SubmitVerification(c *fiber.Ctx) error {
	...
	if err := verifysvc.SubmitDiningVerification(&v); err != nil {
		return c.Status(500).JSON(fiber.Map{"error": err.Error()})
	}
