...
function AccountSetupContent() {
    ...
    useEffect(() => {
        ...
        if (saved.pan) {
            setPan(saved.pan); setPanName(saved.panName ?? '');
            setPanDOB(saved.panDOB ?? ''); setPanCardUrl(saved.panCardUrl ?? '');
        ...
        if (session.id) {
            organizerApi.getExistingSetup('play')
                ...
                .catch((error) => { console.error('Setup loading error:', error); })
            ...
            <main className="flex-1 overflow-y-auto scrollbar-hide px-4 md:px-14 lg:px-32 py-10 md:py-16">
                <div className="max-w-[1100px] mx-auto flex flex-col lg:flex-row gap-16 lg:gap-24">
                    ...
                    <div className="flex-1 flex flex-col pt-4">
                        ...
                        <div className="lg:hidden mb-12"><SetupSidebar currentStep="01" category="play" /></div>
